...
const renderSinglePartyById = async (id,parentContainer) => {
  try {
    ...
    partyDetailsElement.innerHTML = `
        ...
        `;
        partyDetailsElement.style.backgroundColor='blue';
        partyDetailsElement.style.zIndex='2';
        
        
    parentContainer.appendChild(partyDetailsElement);
  ...
  try {
    ...
    parties.forEach((party) => {
      ...
      detailsButton.addEventListener('click', async (event) => {
          const details = await getPartyById(party.id);
